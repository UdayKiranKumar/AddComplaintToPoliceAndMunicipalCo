...
public class AddCollectorComp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_collector_comp);
    ...
    public void DBCreate(){
        ...
        SQLITEDATABASE.execSQL("CREATE TABLE IF NOT EXISTS collectorTable(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR, phone_number VARCHAR, address VARCHAR,complaint VARCHAR);");
    }
    ...
    public void SubmitData2SQLiteDB(){
        ...
        if(CheckEditTextEmpty == true)
        {
            ...
            SQLiteQuery = "INSERT INTO collectorTable (name,phone_number,address,complaint) VALUES('"+Name+"', '"+PhoneNumber+"', '"+Address+"','"+Complaint+"');";

            SQLITEDATABASE.execSQL(SQLiteQuery);

            Toast.makeText(AddCollectorComp.this,"Data Submit Successfully", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(AddCollectorComp.this,"Please Fill All the Fields", Toast.LENGTH_LONG).show();
        }
    }
