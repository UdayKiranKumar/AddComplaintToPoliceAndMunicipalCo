...
public class Addmunicipality extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addmunicipality);
    ...
    public void DBCreate(){
        ...
        SQLITEDATABASE.execSQL("CREATE TABLE IF NOT EXISTS municipalTable(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR, phone_number VARCHAR, address VARCHAR,complaint VARCHAR);");
    }
    ...
    public void SubmitData2SQLiteDB(){
        ...
        if(CheckEditTextEmpty == true)
        {
            ...
            SQLiteQuery = "INSERT INTO municipalTable (name,phone_number,address,complaint) VALUES('"+Name+"', '"+PhoneNumber+"', '"+Address+"','"+Complaint+"');";

            SQLITEDATABASE.execSQL(SQLiteQuery);

            Toast.makeText(Addmunicipality.this,"Data Submit Successfully", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(Addmunicipality.this,"Please Fill All the Fields", Toast.LENGTH_LONG).show();
        }
    }
