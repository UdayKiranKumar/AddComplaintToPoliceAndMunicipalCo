...
public class municipaladapter   extends BaseAdapter {
    ...
    public View getView(int position, View child, ViewGroup parent) {
        ...
        municipaladapter.Holder holder;
        ...
        if (child == null) {
            ...
            holder = new municipaladapter.Holder();
            ...
            holder = (municipaladapter.Holder) child.getTag();
        }
